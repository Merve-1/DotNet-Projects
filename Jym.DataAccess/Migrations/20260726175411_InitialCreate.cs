        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_User_Phone", "LEN([Phone]) LIKE '01[0125]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Weight = table.Column<decimal>(type: "decimal(5,2)", maxLength: 50, precision: 5, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_MemberShip_DateRange", "[EndDate] > [StartDate]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Session_DateRange", "[EndDate]> [StartDate]");
                    table.ForeignKey(
